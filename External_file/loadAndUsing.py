...
#    	,featFile_validate   = "../data/good_vs_bad/CQA-QL-validateel.xml.multi.csv.feat"
	...
	print('LOADING DATA...')
	print('----------------------------------------------------------------')
	(X_newinput, y_newinput), max_features, E, label_id = aidr.load_and_numberize_data2(path=options.data_dir, nb_words=options.max_features, init_type=options.init_type, embfile=options.emb_file, validate_train_merge=0, map_labels_to_five_class=0)

...
#
# Created: Wed May 10 23:41:11 2017
	...
	#global model
        try:
			...
			print("ANSWER IS: ", model.predict_classes(X_newinput))
            		#self.listView.addItem("QUANA")
                    	#Sself.listView.show()
			listView.setGeometry(QtCore.QRect(10, 40, 281, 281))
...
class Ui_PaymentDlg(object):
    ...
    def setupUi(self, PaymentDlg):
        ...
        self.listView.setGeometry(QtCore.QRect(10, 40, 181, 181))
        self.listView.setObjectName(_fromUtf8("listView"))
        self.listView_2 = QtGui.QListView(self.tab_4)
        self.listView_2.setGeometry(QtCore.QRect(210, 40, 181, 181))
        self.listView_2.setObjectName(_fromUtf8("listView_2"))
        self.tabWidget.addTab(self.tab_4, _fromUtf8(""))
        self.verticalLayout.addWidget(self.tabWidget)
	self.listView.addWidget.addItem("QUAN")
    	self.listView.show();

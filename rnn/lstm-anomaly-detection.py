...
def gen_waveEarthquake_Accumulate():
    ...
    y = []
    date_ticks = []
    csvfile='rnn/FromJsontoRawstream_earthquake8_ngay21thag9_Pre_CNNv2__Accumulate10secondsPredZERO_Ori.csv'
...
def run_network(model=None, data=None):
	...
	with open("./saved_modelRNN/modelLSTM.json", "w") as json_file:
    		json_file.write(model_json)
	# serialize weights to HDF5
	model.save_weights("./saved_modelRNN/modelLSTM.h5")
	print("Saved modelLSTM model to disk")
